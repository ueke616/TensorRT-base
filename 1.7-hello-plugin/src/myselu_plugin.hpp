...
// 复杂的插件, 继承自 IPluginV2DynamicExt, 能够更加定制化
...
private:
    const std::string myLayerName;
    std::string mattr1;
    float mattr3;
    size_t myInputVolume;
...
private:
    static PluginFieldCollection myFC;
    static std::vector<PluginField> myPluginAttributes;
    std::string myNamespace;
};
